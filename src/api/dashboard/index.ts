...
// 通道数量
export const channelCount = (data: any) => request.post<number>(`/data-collect/channel/_count`, data)
// 采集器数量
export const collectorCount = (data: any) => request.post<number>(`/data-collect/collector/_count`, data)
// 采集点位
export const collectorPoints = (data: any) => request.post<number>(`/data-collect/point/_count`, data)
// 视频设备数量
