    ...
    children: [
      {
        ...
        description: i18n.global.t('components.data.091431-2'),
      },
      {
        provider: 'alarm-device',
        name: i18n.global.t('components.data.091431-3'),
        description: i18n.global.t('components.data.091431-4'),
      },
      {
        provider: 'alarm-org',
        name: i18n.global.t('components.data.091431-5'),
        description: i18n.global.t('components.data.091431-6'),
      },
      {
        provider: 'alarm-scene',
        name: i18n.global.t('components.data.091431-7'),
        description: i18n.global.t('components.data.091431-8'),
      },
    ],
  },
  {
