    ...
    <a-form :model="form" layout="vertical" ref="formRef">
      <a-row :gutter="24">
        <a-col :span="12">
          ...
          >
            <a-input v-model:value="form.name" :placeholder="$t('EditInfo.index.557023-4')" />
          </a-form-item>
        </a-col>
        <a-col :span="12">
        ...
        <a-col :span="12">
          <a-form-item :label="$t('EditInfo.index.557023-7')">
            <a-input
              :value="form.roleList?.map(item => item.name).join(',')"
        ...
        <a-col :span="12">
          <a-form-item :label="$t('EditInfo.index.557023-9')">
            <a-input
              :value="form.orgList?.map(item => item.name).join(',')"
        ...
        <a-col :span="12">
          <a-form-item :label="$t('EditInfo.index.557023-18')">
            <a-input
              :value="form.positions?.map(item => item.name).join(',')"
        ...
        <a-col :span="12">
          ...
          >
            <a-input v-model:value="form.telephone" :placeholder="$t('EditInfo.index.557023-13')" />
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item
          ...
          >
            <a-input v-model:value="form.email" :placeholder="$t('EditInfo.index.557023-16')" />
          </a-form-item>
        </a-col>
      </a-row>
    </a-form>
