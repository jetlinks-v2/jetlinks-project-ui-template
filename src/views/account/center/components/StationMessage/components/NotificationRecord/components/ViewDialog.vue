...
import { getWorkflowNotice, queryLevel as queryLevel_api } from '@/api/account/notificationRecord';
  ...
  if (
    ...
    const params = {
      terms: [
        {
          type: 'or',
          value: ['workflow-process-finish', 'workflow-process-repealed'].includes(
