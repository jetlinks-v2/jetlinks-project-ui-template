    ...
    <div class="built_in_group">
      ...
      <div class="group">
        ...
        >
          <div
            class="group_name"
            :class="{ group_selected: item.selected }"
          ...
          <div v-if="item.show">
            <a-button block @click="() => selectGroup(item)">
              {{ item.selected ? $t('Role.index.263636-1') : $t('Role.index.263636-2') }}
            </a-button>
            <a-button block @click="() => showEditGroup(item, index)">
              {{ $t('Role.index.263636-3') }}
            </a-button>
          </div>
        </div>
        <a-button type="text" @click="showAddGroup" :disabled="group.length >= 10">
          {{ $t('Role.index.263636-4') }}
        </a-button>
      </div>
    </div>
    <a-checkbox-group @change="getCheckValue">
      <div class="init-home-role-content">
        <div
          ...
          :style="keys.includes('device') ? 'background-color: #f5f5f5;' : ''"
        >
        ...
        <div
          ...
          :style="keys.includes('link') ? 'background-color: #f5f5f5;' : ''"
        >
          <div class="role-item-title">
        ...
        <div
          ...
          :style="keys.includes('complex') ? 'background-color: #f5f5f5;' : ''"
        >
          <div class="role-item-title">
