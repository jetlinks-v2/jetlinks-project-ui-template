            ...
            <a-collapse v-model:activeKey="activeKey" accordion>
              <a-collapse-panel key="1">
                <template #header>
                  ...
                  <span class="sub-title">{{ $t('init-home.index.011430-2') }}</span>
                </template>
                <Basic ref="basicRef" />
              </a-collapse-panel>
              <a-collapse-panel key="2" forceRender>
                <template #header>
                  ...
                  <span class="sub-title">{{ $t('init-home.index.011430-4') }}</span>
                </template>
              ...
              <a-collapse-panel key="3" forceRender>
                <template #header>
                  ...
                  <span class="sub-title">{{ $t('init-home.index.011072-1') }}</span>
                </template>
                <Role ref="roleRef"></Role>
              </a-collapse-panel>
            </a-collapse>
          </a-spin>
          <a-button type="primary" class="btn-style" @click="submitData" :loading="loading">
