...
<template>
  <a-form layout="vertical" :model="form" ref="formBasicRef">
    <a-row :span="24" :gutter="24">
      <a-col :span="12">
        <a-form-item label="系统名称" name="title" :rules="rulesFrom.title">
          <a-input v-model:value="form.title" placeholder="请输入系统名称" />
        </a-form-item>
        <a-form-item
          label="主题色"
          name="headerTheme"
          :rules="rulesFrom.headerTheme"
        >
        ...
        <a-form-item name="basePath" :rules="rulesFrom.basePath">
          <template #label>
            <span>base-path</span>
            <a-tooltip>
              <template #title>
        ...
        <a-form-item
          ...
          :required="true"
        >
          <a-switch v-model:checked="form.showRecordNumber"></a-switch>
        </a-form-item>
        <a-form-item
                  ...
                  >
                    <div class="upload-image-content-logo">
                      <div class="loading-logo" v-if="logoLoading">
                        <AIcon type="LoadingOutlined" style="font-size: 28px" />
                      </div>
                      <div
                        class="upload-image"
                        v-if="form.logo"
                      ...
                      <div v-else>
                        ...
                        <div v-else>
                          <AIcon type="PlusOutlined" style="font-size: 28px" />
                        </div>
                      </div>
                    </div>
                  </a-upload>
              ...
              <div class="upload-image-warp-logo">
                <div class="upload-image-border-logo">
                  <a-upload
                    ...
                    :accept="
                      iconTypes && iconTypes.length ? iconTypes.toString() : ''
                    "
                  >
                    <div class="upload-image-content-logo">
                      ...
                      <div
                        ...
                        v-if="form.ico"
                        :style="
                          form.ico ? `background-image: url(${form.ico});` : ''
                        "
                      ></div>
...
import { formState } from "../data/interface";
