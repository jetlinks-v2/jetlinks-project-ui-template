    ...
    <div class="form-container">
      <div class="form-left">
        <a-form-item :label="$t('Basis.Form.436809-0')" name="title">
          <a-input v-model:value="formData.title" :placeholder="$t('Basis.Form.436809-1')" />
        </a-form-item>
        <a-form-item :label="$t('Basis.Form.436809-2')" name="headerTheme">
          <a-select v-model:value="formData.headerTheme" :options="headerThemeAreas"></a-select>
        </a-form-item>
        ...
        <a-form-item name="webKey">
          <template #label>
            <a-space>
              ...
              <a-tooltip :title="$t('Basis.Form.436809-4')">
                <AIcon type="QuestionCircleOutlined" />
              </a-tooltip>
            </a-space>
          </template>
          <a-input
            v-model:value="formData.webKey"
            :placeholder="$t('Basis.Form.436809-5')"
          ></a-input>
        </a-form-item>
        <a-form-item name="apiKey">
          ...
          <a-input
            ...
            :placeholder="$t('Basis.Form.436809-8')"
          ></a-input>
        </a-form-item>
        <a-form-item>
          <template #label>
            <a-space>
              ...
              <a-tooltip :title="$t('Basis.Form.436809-10')">
                <AIcon type="QuestionCircleOutlined" />
              </a-tooltip>
            </a-space>
          </template>
          <a-input v-model:value="formData.secretKey" :placeholder="$t('Basis.Form.436809-11')" />
        </a-form-item>
        <!-- base-path输入框 -->
