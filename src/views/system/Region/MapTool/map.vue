<template>
  <div class="region-map">
    <AMapComponent ref="mapRef">
      ...
      />
      <GeoJson v-if="showGeoJson" :geo="pathData" />
      <el-amap-mouse-tool v-if="showTool" :type="toolType" @draw="toolDraw" />
    </AMapComponent>
    <div class="map-tool" v-if="showToolDom">
      <div class="map-tool-content">
        ...
        <div class="tool-item-group">
          <div
            :class="{ 'tool-item': true, active: toolType === 'rectangle' }"
            @click="changeToolType(MAP_TOOL.rectangle)"
          >
          ...
          <div
            :class="{ 'tool-item': true, active: toolType === 'polygon' }"
            @click="changeToolType(MAP_TOOL.polygon)"
          >
