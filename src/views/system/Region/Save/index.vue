    ...
    <div style="margin-top: 10px">
      <a-form :layout="'vertical'" ref="formRef" :model="modelRef">
        ...
        <template v-else>
          ...
          >
            <a-input v-model:value="modelRef.name" :placeholder="$t('Save.index.968210-8')" />
          </a-form-item>
          <a-form-item
          ...
          <a-form-item :label="$t('Save.index.968210-12')">
            <RadioButton
          ...
          <div v-if="modelRef.properties.partition === 'manual'">
            ...
            >
              {{ $t('Save.index.968210-15') }}
            </a-button>
            <template v-else>
              <a-space>
                <span>{{ $t('Save.index.968210-16') }}</span>
                <a-button type="link" style="padding: 0" @click="showEditMap(true)">
                  {{ $t('Save.index.968210-17') }}
                </a-button>
              </a-space>
            </template>
          </div>
