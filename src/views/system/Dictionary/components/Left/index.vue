<template>
  <div class="left-contain">
    <a-input
      :placeholder="$t('Left.index.036608-0')"
          ...
          <div class="treeItem" @click="() => selectDic(item.data)">
            ...
            <div @click="e => e.stopPropagation()">
              <a-popconfirm
                ...
                :title="
                  item.data.status === 1 ? $t('Left.index.036608-4') : $t('Left.index.036608-5')
                "
                @confirm="() => updateDic(item.data)"
              >
                <a-switch
                  :checked="item.status"
                  :disabled="!permission.hasPerm.value || item.data.classified === 'system'"
                  :checkedValue="1"
                  :unCheckedValue="0"
                ></a-switch>
              </a-popconfirm>
              <a-tooltip
                ...
                placement="top"
                :title="
                  !permission.hasPerm.value ? $t('Left.index.036608-6') : $t('Left.index.036608-7')
                "
              >
                <a-switch
                  :checked="item.status"
              ...
              <j-permission-button
                ...
                :tooltip="
                  item.data.classified === 'system' ? { title: $t('Left.index.036608-7') } : null
                "
