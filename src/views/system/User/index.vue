<template>
  <j-page-container>
    <div class="user-container">
      <pro-search :columns="columns" target="system-user" @search="handleParams" />
      <FullPage>
        <j-pro-table
          ref="tableRef"
          :columns="columns"
          ...
          <template #action="slotProps">
            <a-space :size="16">
              ...
              <j-permission-button
                ...
                :tooltip="{
                  title: slotProps.status ? $t('User.index.673867-7') : $t('User.index.673867-8'),
                }"
                :popConfirm="{
