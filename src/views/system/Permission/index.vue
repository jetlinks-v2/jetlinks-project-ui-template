      ...
      >
        ...
        <template #status="slotProps">
          <j-badge-status
            ...
            :text="
              slotProps.status ? $t('Permission.index.473829-5') : $t('Permission.index.473829-6')
            "
            :statusNames="{
              1: 'success',
              0: 'error',
        ...
        <template #action="slotProps">
          <a-space :size="16">
            ...
            <j-permission-button
              ...
              :tooltip="{
                title: slotProps.status
                  ? $t('Permission.index.473829-6')
                  : $t('Permission.index.473829-5'),
              }"
            >
            ...
            <j-permission-button
              ...
              :tooltip="{
                title: !!slotProps.status
                  ? $t('Permission.index.473829-9')
                  : $t('Permission.index.473829-10'),
              }"
              danger
              :popConfirm="{
...
import type { PermissionItem } from './typings';
