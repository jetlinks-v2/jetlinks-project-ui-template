  ...
  >
    <div class="import-content">
      <div class="column">
        ...
        <div class="import">
          <a-upload-dragger
            ...
            name="file"
            :action="`${BASE_API}${FileStatic}?options=tempFile`"
            :headers="{
      ...
      <div class="column" v-if="importStatus != 'wait'">
        <p>
          <AIcon type="CheckOutlined" style="color: #00a4ff" />
          导入成功 总数量
          {{ successNumber }}
        </p>
...
import { exportTemplate } from '@/api/data-collect/collector'
import {
  onlyMessage,
  downloadFileByUrl,
  LocalStore,
