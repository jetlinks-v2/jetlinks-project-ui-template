<template>
  <a-spin :spinning="loading">
    <div class="dash-board" :style="{ backgroundColor: configData.componentProps.background }">
      <div class="header">
        <div class="left">
      ...
      <div>
        <j-empty v-if="isEmpty" style="height: 250px; margin-top: 100px" />
        <template v-else>
...
import { getTimeByType, typeDataLine, colorNetwork, networkParams } from './components/tools';
